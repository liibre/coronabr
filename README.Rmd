...
# _Download_ de dados de COVID-19 no Brasil
...
+ A partir de 2020-03-28 a opção de fazer _download_ da série histórica por casos voltou a estar disponível. Depois disso, o padrão vem mudado frequentemente, mas agora temos uma função estável `get_corona_minsaude()` para o _download_ desses dados (instruções de como usar [aqui](https://liibre.github.io/coronabr/articles/minsaude.html)). 
